"""
Django settings for quiet_shape_41958 project.
...
ROOT_URLCONF = 'quiet_shape_41958.urls'
...
WSGI_APPLICATION = 'quiet_shape_41958.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_shape_41958 API",
    "DESCRIPTION": "API documentation for quiet_shape_41958 App",
    "VERSION": "v1",
}
